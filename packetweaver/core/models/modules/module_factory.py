...
class ModuleFactory(object):
    ...
    Warning : the factory does not check that modules are valid. These tests
    are hand down to the calling functions
    """
    ...
    def load_module(module_path):
        ...
        """
        return imp.load_module(module_path, None, module_path,
                               ('', '', imp.PKG_DIRECTORY))
    ...
    def get_module(module_path, view=output.Log()):
        ...
        :param view: a ViewsInterface subclass to handle user interface
            display. Needed to instantiate the ModuleModel
        """
